...
OPERATIONAL_METRICS: list[dict[str, Any]] = [
    ...
    {
        "path": "search.build context pack.last_result_count",
        "direction": "invariant",
        "expected": 20,
    },
    {
        "path": "search.build context pack.top_path",
        "direction": "invariant",
        "expected": "src/lode/context.py",
    },
    {"path": "search.embedding queue.timing_ms.p50", "direction": "lower_is_better"},
    {
        "path": "search.embedding queue.last_result_count",
        "direction": "invariant",
        "expected": 20,
    },
    {
        "path": "search.embedding queue.top_path",
        "direction": "invariant",
        "expected": "src/lode/embeddings.py",
    },
    {"path": "symbols.build_context_pack.timing_ms.p50", "direction": "lower_is_better"},
    {
        "path": "symbols.build_context_pack.top_path",
        "direction": "invariant",
        "expected": "src/lode/context.py",
    },
    {"path": "context.build context pack.timing_ms.p50", "direction": "lower_is_better"},
    {
        "path": "context.build context pack.must_read_count",
        "direction": "invariant",
        "expected": 10,
    },
    {
        "path": "context.build context pack.top_hit_count",
        "direction": "invariant",
        "expected": 10,
    },
    {
        "path": "context.build context pack.confidence",
        "direction": "invariant",
        "expected": "strong",
    },
    {"path": "context.embedding queue.timing_ms.p50", "direction": "lower_is_better"},
    {
        "path": "context.embedding queue.must_read_count",
        "direction": "invariant",
        "expected": 10,
    },
    {
        "path": "context.embedding queue.top_hit_count",
        "direction": "invariant",
        "expected": 10,
    },
    {
        "path": "context.embedding queue.confidence",
        "direction": "invariant",
        "expected": "strong",
    },
